            ...
            for clique1 in pareja[0]:
                ...
                for clique2 in pareja[1]:
                    ...
                    if score_ss(res_clq_1, res_clq_2):
                        ...
                        # if set(clique_a_seguir1).issubset(clique1) and set(clique_a_seguir2).issubset(clique2) \
                        #         and align(coord_1, coord_2) < restriccion_rmsd:
                        #     print("RMSD: %1.5f" % align(coord_1, coord_2))
                        #     print(clique1, clique2)
                        # if clique_a_seguir1 == clique1[:3] and clique_a_seguir2 == clique2[:3] and \
                        #         align(coord_1, coord_2) < restriccion_rmsd:
                        #     print("RMSD: %1.5f" % align(coord_1, coord_2))
                        #     print(clique1, clique2)
            ...
            for clique2 in cliques_2_align:
                ...
                if score_ss(res_clq_1, res_clq_2):
                    ...
                    if align(coord_1, coord_2) < restriccion_rmsd:
                        ...
                        # print(clique1, clique2)
                        cliques_candidate.append([clique1, clique2])
                        rmsd_candidates.append([align(coord_1, coord_2), clique1, clique2])
                        #check de lementos 7
                    # if number_elements_clique == 7:
                    #     print("RMSD: %1.5f" % align(coord_1, coord_2))
                    #     print(clique1, clique2)
                    # if number_elements_clique == 7:
                    #     rmsd_candidates.append([align(coord_1,coord_1), clique1, clique2])
        #check de seguir cliques
                    # if set(clique_a_seguir1).issubset(clique1) and set(clique_a_seguir2).issubset(clique2) \
                    #         and align(coord_1, coord_2) < restriccion_rmsd:
                    #     print("RMSD: %1.5f" % align(coord_1, coord_2))
                    #     print(clique1, clique2)
                    ...
                    #         align(coord_1, coord_2) < restriccion_rmsd:
                        ...
                        # print(clique1, clique2)
    if number_elements_clique == 7:
        return rmsd_candidates, cliques_candidate

    return cliques_candidate

# [[108, 107, 105, 104, 106, 109, 110], [140, 141, 143, 144, 142, 139, 138]]
# clique_a_seguir1 = [108, 107, 105]
# clique_a_seguir2 = [140, 141, 143]
#
# cliques_a_seguir_2 = [[141, 146, 144, 145, 147, 142, 143], [130, 135, 133, 134, 136, 131, 132]]
...
cliques_temp1 = []
cliques_temp1_add = []
for parejas_4clique in cliques_temp_add_0:
...
cliques_temp2 = []
cliques_temp2_add = []
for parejas_5clique in cliques_temp_add_11:
...
for parejas_6clique in cliques_temp_add_22:

    new_df_cliques1 = parejas_6clique[0]
    new_df_cliques2 = parejas_6clique[1]
    rmsd,cliques_candidatos = iter_align(number_elements_clique, new_df_cliques1, new_df_cliques2)

    if cliques_candidatos != []:
        cliques_temp3.append(rmsd)


pd.DataFrame(cliques_temp3).to_pickle('rmsd_7.pkl')
# print(cliques_temp3[:5])
# print(len(cliques_temp3))
# print(cliques_temp3[:2])

# AQUI HAY UN LIGERO PROBLEMA POR QUE TENGO 41K CANDIDATOS !!!!!!....
